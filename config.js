module.exports = {
    /*
      The client ID must be inputed from the Discord dev portal if you want to use your own assets
    ...
    */
    ...
    /*
      ...
      For now these use default values from the deafult client.
    */
    largeImage: "woc",
    largeText: "World of Coding!",
}